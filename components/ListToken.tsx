  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex justify-between items-end">
        ...
        <button onClick={() => setIsCreatePop(true)} className="p-2 px-4 my-4 bg-black rounded-lg hover:scale-105 transition-all delay-75 dark:bg-white text-white dark:text-black">
          Create Token
        </button>
      </div>
